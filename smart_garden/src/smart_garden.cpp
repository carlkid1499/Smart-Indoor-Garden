...
/* ----- Begin: Define Funcs/Tasks ----- */
void setup();
void loop();
void SD_TASK();
void RTC_TASK();
void WEB_SERVER_TASK();
void static handleRoot();
void static handleNotFound();
void static drawGraph();
/* -----  End: Define Funcs/Tasks ----- */

/* Begin: Define Global Vars -----*/
RTC_PCF8523 rtc;
char daysOfTheWeek[7][12] = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"};
WebServer server(80);
const int led = LED_BUILTIN;
/* End: Define Global Vars -----*/
